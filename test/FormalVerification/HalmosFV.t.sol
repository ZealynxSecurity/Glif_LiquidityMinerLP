...
import {BaseHalmos} from "test/Utils/BaseHalmos.sol";
...
contract HalmosFVLiquidityMine is BaseHalmos {
    using FixedPointMathLib for uint256;


    function check_Deposit_CheckBalances(uint256 amount) public {
        // Assumptions
